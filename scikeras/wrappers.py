...
class BaseWrapper(BaseEstimator):
    ...
    def __init__(
        ...
        *,
        ...
        metrics: Union[
            List[Union[str, tf.keras.metrics.Metric, Type[tf.keras.metrics.Metric], Callable,]], None,
        ] = None,
        batch_size: Union[int, None] = None,
        verbose: int = 1,
        callbacks: Union[List[Union[tf.keras.callbacks.Callback, Type[tf.keras.callbacks.Callback]]], None,] = None,
    ...
    def _get_compile_kwargs(self):
        ...
        compile_kwargs = route_params(init_params, destination="compile", pass_filter=self._compile_kwargs,)
        ...
        compile_kwargs["optimizer"] = unflatten_params(
            ...
            params=route_params(init_params, destination="optimizer", pass_filter=set(), strict=True,),
        )
        ...
        compile_kwargs["loss"] = unflatten_params(
            ...
            params=route_params(init_params, destination="loss", pass_filter=set(), strict=False,),
        )
        ...
        compile_kwargs["metrics"] = unflatten_params(
            ...
            params=route_params(init_params, destination="metrics", pass_filter=set(), strict=False,),
        )
    ...
    def _build_keras_model(self):
        ...
        build_params = route_params(params, destination="model", pass_filter=getattr(self, "_user_params", set()),)
        compile_kwargs = None
    ...
    def _validate_data(
        ...
        if y is not None:
            y = check_array(y, ensure_2d=False, allow_nd=False, dtype=_check_array_dtype(y, force_numeric=y_numeric),)
            y_dtype_ = y.dtype
            y_ndim_ = y.ndim
            if reset:
    ...
    def _fit(self, X, y, sample_weight, warm_start: bool, epochs: int, initial_epoch: int, **kwargs,) -> None:
        """Constructs a new model with ``model`` & fit the model to ``(X, y)``.
    ...
    def partial_fit(self, X, y, sample_weight=None) -> "BaseWrapper":
        ...
        """
        self._fit(
            X, y, sample_weight=sample_weight, warm_start=True, epochs=1, initial_epoch=self.current_epoch,
        )
        return self
...
class KerasClassifier(BaseWrapper):
    ...
    def predict_proba(self, X, **kwargs):
        ...
        **kwargs : Dict[str, Any]
        ...
        # collect arguments
        predict_args = route_params(self.get_params(), destination="predict", pass_filter=self._predict_kwargs,)
...
class KerasRegressor(BaseWrapper):
    ...
    def r_squared(y_true, y_pred):
        ...
        ss_tot = tf.math.reduce_sum(tf.math.squared_difference(y_true, tf.math.reduce_mean(y_true, axis=0)), axis=0,)
